...
function EMPrivacyPolicy() {
  return (
    <Row>
      <Col>
        <strong>Privacy Policy</strong>{" "}
        <p>
          Sham Vice Tech built the Epic Monitor app as a Free app. This SERVICE
          is provided by Sham Vice Tech at no cost and is intended for use as
          is.
        </p>{" "}
        <p>
        ...
        <p>
          ...
          Terms and Conditions, which is accessible at Epic Monitor unless
        ...
        <p>
          ...
          not hesitate to contact me at jecsham27@gmail.com.
        </p>{" "}
        <p>
