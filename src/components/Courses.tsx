                        ...
                        <div className="d-flex justify-content-center flex-wrap mt-3" id="cards-platzi-courses">
                            {
                                this.state.courses.map((item: any, i: number) => (
                                    <a key={i} href={`https://platzi.com${item.diploma_link}`} target="_blank" rel="noopener noreferrer" className="j-nounderline text-dark">
                                            ...
                                            <div className="card-body">
                                                <table className="j-table-float-center">
                                                    <tbody>
                                                        <tr>
                                                            <td>
                                                                <img src={item.badge || item.golden_achievement} className="j-img-card-platzi rounded-circle"
                                                                    alt={item.title} />
                                                            </td>
                                                            <td>
                                                                <h5 className="card-title ml-3 mb-0">{item.title}</h5>
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
