      ...
      <Col>
        <div className="d-flex justify-content-center">
          <div className="text-center my-3">
            ...
            <a
              href="https://platzi.com/@jecsham/"
              target="_blank"
              rel="noopener noreferrer"
              className="card-link"
            >
              <i className="mdi mdi-platzi"></i>
              Platzi
            </a>
            <a
            ...
            <a
              href="https://www.linkedin.com/in/jecsham-castillo-07599aa7/"
              className="card-link"
              rel="noopener noreferrer"
              target="_blank"
            >
            ...
            <p className="card-text font-weight-light">
              Hi, I'm Jecsham, I'm {yearsOld(27, 11, 1997)} years old and I
              consider myself a Fullstack Developer. <br />
            </p>
          </div>
        </div>
      </Col>
