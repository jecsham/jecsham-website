...
const EmPrivacyPolicy: NextPage = () => {
  return (
    <div className="container">
      <div className="my-4">
        <strong>Privacy Policy</strong>{" "}
        <p>
          Sham Vice Tech built the Epic Monitor app as a Free app.
          This SERVICE is provided by Sham Vice Tech at no cost and is
        ...
        <p>
          ...
          as in our Terms and Conditions, which is accessible at Epic
          Monitor unless otherwise defined in this Privacy Policy.
        </p>{" "}
        <p>
          <strong>Information Collection and Use</strong>
        </p>{" "}
        <p>
          While using our Service, I require you to provide us with
          certain user configurations information. The information
        ...
        <p>This policy is effective as of 2021-06-11</p>{" "}
        <p>
...
export default EmPrivacyPolicy;
